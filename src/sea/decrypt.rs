...
pub async fn decrypt(
    ...
    let iv_bytes = general_purpose::STANDARD_NO_PAD
        .decode(iv_b64)
        .map_err(|_| SeaError::Decryption("Invalid IV encoding".to_string()))?;
    let salt_bytes = general_purpose::STANDARD_NO_PAD
        .decode(s_b64)
